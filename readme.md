# PCB Component Inspection Dataset + YOLOv8 Training Weights
...
Description
Contains 2,047 labeled images, can detect 21 types of PCB components such as batteries, buttons, buzzers, capacitors, ICs, LEDs, resistors, relays, etc., suitable for training with YOLOv8 and YOLO11. The material includes training set, validation set, test set, and the best.pt model of YOLOv8s training.
